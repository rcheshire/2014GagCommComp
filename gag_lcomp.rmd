...
table1=xtable(hl.norm.w.out,digits=c(0,0,rep(5,dim(hl.norm.w.out)[2]-1)))
print(table1,type="html")
```
...
table1=xtable(dv.norm.w.out,digits=c(0,0,rep(5,dim(dv.norm.w.out)[2]-1)))
print(table1,type="html")
```
Figures
-------------------------
...
table7=xtable(acomp.hl.w.norm3,digits=c(0,0,rep(5,dim(acomp.hl.w.norm3)[2]-1)))
